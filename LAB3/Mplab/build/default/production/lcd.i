...
void PUERTO(uint8_t x){
    ...
    if(x & 2){RB1=1;}else{RB1=0;}
    if(x & 4){RB2=1;}else{RB2=0;}
    if(x & 8){RB3=1;}else{RB3=0;}
    if(x & 16){RB4=1;}else{RB4=0;}
    if(x & 32){RB5=1;}else{RB5=0;}
    if(x & 64){RB6=1;}else{RB6=0;}
    if(x & 128){RB7=1;}else{RB7=0;}
